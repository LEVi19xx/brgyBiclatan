...
<body>
    ...
    <div class="container">
        ...
        <form method="post" class="input-container">
                ...
                <div class="div">
                    <div class="g-recaptcha" data-sitekey="6LdM0DgUAAAAAHtPjQfbqTX6viYFbOvkcFs_twDp" style="transform:scale(0.8);transform-origin:0;-webkit-transform:scale(0.8);transform:scale(0.8); width:306px;">
                    </div>
                </div>
