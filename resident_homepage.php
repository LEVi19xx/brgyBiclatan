    ...
    <body> 
        ...
        <nav class="navbar navbar-dark bg-primary sticky-top">
            ...
            <a class="navbar-brand" href="resident_homepage.php" style="margin-left:10px"><b>Barangay Biclatan Information System</b></a>
             <a href="#down2" class="btn1 bg-primary">Announcement</a>
            <a href="#down1"  class="btn2 bg-primary">E-Services</a>
            <a href="#down" class="btn3 bg-primary">Contact</i></a>
        ...
        <div class="header"> 
                            <br><br><br><center><h2 style="font-size: 50px;"> Welcome to <br><b>Barangay Biclatan Information System</b></h2><bR></center>
                        </div>
        <div  id="down2"></div>
<br><br>
        <?php 
