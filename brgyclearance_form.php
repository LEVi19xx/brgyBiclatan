...
<style>
    ...
    @media print {
        ...
        img[src="icons/signature.png"] {
            margin-left: 150px !important; /* Reset margin for print */
        }
        .noprint {
       ...
       <div class="col-xs-12 col-sm-6 col-md-8">
                ...
                background-repeat: no-repeat; background-position: center; background-size: 80%; background-color: rgba(255, 255, 255, 0.9); background-blend-mode: overlay; background-position: center top; height: 800px;">
                        ...
                        <p class="print-padding" style="text-indent:40px;text-align: justify;">THIS IS TO CERTIFY that Mr/Ms/Mrs <b><?= $resident['lname'];?>, <?= $resident['fname'];?> <?= $resident['mi'];?></b>,
                          of legal age, <b><?= $resident['status'];?></b>. Filipino citizen, a bonafide resident of barangay and presently residing at <u><b><?= $resident['houseno'];?>, <?= $resident['street'];?>, <?= $resident['brgy'];?>, <?= $resident['municipal'];?>,</b></u> City of General Trias, Cavite.</p> 
...
?>
                        ...
                        <div style="display: flex;">
                            <div style="flex: 1;"><br><br>
                                <image src="icons/signature.png" style="width:100px; margin-left:-30px; position: absolute;"/><br>
